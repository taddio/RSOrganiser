...
public class EventFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new ArrayAdapter<String>(getActivity(), layout, EventDescriptions.Events));
    }
    ...
    public void onStart() {
        ...
        if (getFragmentManager().findFragmentById(R.id.description_fragment) != null) {
